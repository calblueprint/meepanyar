...
function updateRecord(table: string, id: string, fields: {}): Promise<string> {
  return base(table)
    .update([
      {
        id,
...
export { base, createRecord, updateRecord, getAllRecords, getRecordById, getRecordsByAttribute, deleteRecord };
