export default {
  ...
  "new_meter_reading_kwh": "New Meter Reading (kWh)",
  ...
  "suggested_amount_payment": "Suggested Amount [Payment]",
  ...
  "enter_amount_in_ks_payment": "Enter amount in Ks [Payment]",
  "ending_meter": "Ending Meter",
  "period_usage": "Period Usage",
  "starting_meter": "Starting Meter",
  "fixed_tariff": "Fixed [Tariff]",
  "free_units_tariff": "Free units [Tariff]",
  "per_kwh_tariff": "Per kWh [Tariff]",
  ...
  "site_energy_eg_solar_diesel": "Site Energy [e.g. Solar, Diesel]",
  ...
  "try_again": "Try Again",
  "partner_organization_eg_mee_panyar": "Partner Organization [e.g. Mee Panyar]",
  "site_name": "Site name",
  ...
  "period": "Period",
  "payments_site": "Payments [Site]",
  "reports": "Reports",
  "paid_by_user": "Paid by [User]",
  "account": "Account",
  "bank": "Bank",
  "new_app_users": "New app users",
  "payment_amount_site": "Payment Amount [Site]",
  "payslip": "Payslip",
  "recipient": "Recipient",
  ...
  "rejected_inventory_purchase": "Rejected [Inventory Purchase]",
  "to_collect_customers": "To Collect [Customers]",
  "to_meter_customers": "To Meter [Customers]",
  "total_owed_to_mpy": "Total Owed to MPY",
  "profit": "Profit",
  "issues_solved_incidents": "Issues Solved [Incidents]",
  "issues_unsolved_incidents": "Issues Unsolved [Incidents]",
  "jobs_done": "Jobs Done",
  "jobs_not_done": "Jobs Not Done",
  "mpys_share_profit": "MPY's share [Profit]",
  "outstanding_payments": "Outstanding [Payments]",
  "payment_rate_": "Payment Rate (%)",
  "submitted_automatically_on_date": "Submitted automatically on [date]",
  "to_approve_inventory_purchase": "To Approve [Inventory Purchase]",
  "approved_inventory_purchases": "Approved [Inventory Purchases]",
  "billed_money": "Billed [Money]",
