  ...
  return (
    <BaseScreen title="Base Components" leftIcon="backNav">
      <BaseScrollView>
        ...
        <CameraButton id="take-picture-error" goBack={-1} label="Camera button with error" error helperText="Could not add photo. Please try again." />
        ...
        <form noValidate className={classes.content} onSubmit={() => false}>
          ...
          <TextField disabled label={'Disabled'} id={'disabled'} placeholder={'Disabled placeholder'} />
          <TextField label={'Resting Required with Helper Text'} id={'resting-required'} helperText={'Helper text'} />
